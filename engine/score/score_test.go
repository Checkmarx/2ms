...
func TestScore(t *testing.T) {
	...
	expectedCvssScores := map[string][3]float64{ // ruleID -> Valid, Invalid, Unknown
		...
		rules.OldAtlassian().RuleID:                               {9.4, 3.4, 6.4},
		rules.OldAuthenticatedURL().RuleID:                        {10, 5.2, 8.2},
		ruleConfig.Authress().RuleID:                              {10, 7, 10},
		rules.OldAWS().RuleID:                                     {10, 7, 10},
		...
		rules.OldGitlabPatRoutable().RuleID:                       {10, 5.2, 8.2},
		...
		rules.OldGitlabRunnerAuthenticationTokenRoutable().RuleID: {10, 5.2, 8.2},
		...
		rules.OldOnePasswordSecretKey().RuleID:                    {10, 7, 10},
		...
		rules.OldPlaidAccessID().RuleID:                           {9.4, 3.4, 6.4},
		...
		rules.OldPrivateKey().RuleID:                              {10, 5.2, 8.2},
		...
		rules.OldSumoLogicAccessID().RuleID:                       {7.6, 1.6, 4.6},
		rules.OldSumoLogicAccessToken().RuleID:                    {7.6, 1.6, 4.6},
		...
		rules.OldVaultServiceToken().RuleID:                       {10, 7, 10},
