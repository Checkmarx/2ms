...
// Source: github.com/checkmarx/2ms/v4/plugins (interfaces: ISourceItem)
//
// Generated by this command:
//
//	mockgen -destination=plugins_mock_test.go -package=engine github.com/checkmarx/2ms/v4/plugins ISourceItem
//
