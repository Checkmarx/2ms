...
// Source: github.com/checkmarx/2ms/v5/plugins (interfaces: ConfluenceClient)
//
// Generated by this command:
//
//	mockgen -destination=confluence_client_mock_test.go -package=plugins github.com/checkmarx/2ms/v5/plugins ConfluenceClient
//
